...
<html lang="en">
  ...
  <center>
    ...
    <!-- Sign in  -->
    <div class="form-container sign-in-form" id="card1">
        <div class="form-box sign-in-box">
          <h2>Login</h2>
          <form action="login.php" method="POST" onsubmit="return checkFirstForm(this);">
            <div class="field">
              <i class="uil uil-at"></i>
              <input type="email" value="<?php echo $email; ?>" name="email" id="email" onkeypress="isNotChar(event)" required />
            </div>
            <div class="field">
              ...
              <input
                ...
                value="<?php echo $_POST['pw']; ?>" name="pw" id="pw" onkeypress="isNotChar(event)"
                required
              />
              <div class="eye-btn">
      ...
      <h4 class = "sign" > Login to your existing account</h4>
