...
<html lang="en">
  <head>
    ...
    <title>SupplyBlock - Add Products</title>
  ...
  <body style="background-image: url('bkground.jpg');">
    ...
    <div class="bgrolesadd">
      <center>
        <div>
            <div class="greyarea">
                <h2 style="color: #fff; font-size: 26px;"> SupplyBlock - Add new products </h2>
    ...
    $('#form1').on('submit', function(event) {
        ...
        web3.eth.getAccounts().then(async function(accounts) {
          ...
          .then(receipt => {
              var msg="<h5 style='color: #444'><b>Item Added Successfully</b></h5><p>Product ID: "+receipt.events.Added.returnValues[0]+"</p>";
              qr.value = receipt.events.Added.returnValues[0];
              $bottom="<p style='color: #444'> You may print the QR Code if required </p>"
              $("#alertText").html(msg);
              $("#qrious").show();
